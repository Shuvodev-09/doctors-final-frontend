...
const Footer = () => {
  return (
    <div style={{ backgroundImage: `url(${footbg})`, backgroundSize: 'cover' }}>
      <footer className="footer justify-between text-neutral-content p-10">
        <nav>
          ...
          <a className="link link-hover hover:text-secondary">Weekly Checkup</a>
        ...
        <nav>
          ...
          <a className="link link-hover hover:text-secondary">Cavity Filling</a>
          <a className="link link-hover hover:text-secondary">
            Teath Whitening
          </a>
        </nav>
